...
\begin{document}
    ...
    \section{AI Boxing Strategies}
        ...
        \citep{armstrongforthcoming} schlagen deshalb vor, die Ausgaben der AI zu limitieren (\textit{throtteling}), sodass
        ...
        entwickelt. \cite[p. 37]{chalmers2010singularity} Die AI läuft also in einer virtuellen Umgebung innerhalb eines
        Computers, sodass die AI sich vollständig in dieser Welt entfalten kann. So können beispielsweise die Abläufe und
        Entscheidungen der AI studiert und analysiert werden, ohne dass die AI Schaden in der echten Welt anrichten kann.
